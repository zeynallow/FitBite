    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <form class="" action="{{url('/admin/page/update').'/'.$page->id}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="content" id="editor1" rows="8" cols="80" class="form-control">{!! $page->content !!}</textarea>
